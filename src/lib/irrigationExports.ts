...
export const IRR_BN = {
  ...
  discount: "ডিসকাউন্ট",
  discountReason: "ডিসকাউন্টের কারণ",
  discountedPayable: "ডিসকাউন্টের পর প্রদেয়",
  payable: "প্রদেয়",
  paid: "পরিশোধিত",
  due: "বকেয়া",
  status: "স্ট্যাটাস",
...
export const IRR_EN: typeof IRR_BN = {
  ...
  discountedPayable: "Discounted Payable",
  payable: "Payable",
  paid: "Paid",
  due: "Due",
  status: "Status",
...
export function flattenInvoiceForExport(inv: any, lang: Lang = "bn") {
  ...
  return {
    ...
    [L.landSize]: invoiceBilledArea(inv) != null
      ? formatLandSize(invoiceBilledArea(inv), lang === "en" ? "ascii" : "with_katha")
      : "",
    ...
    [L.discount]: r(inv.discount_amount ?? 0),
    [L.discountReason]: inv.discount_reason ?? "",
    [L.discountedPayable]: r(inv.payable_amount ?? ""),
