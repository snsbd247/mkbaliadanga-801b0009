...
//
// IMPORTANT: use the backend-aware `db` client (not the raw supabase client) so
// that on the VPS/Laravel deployment the receipt number is generated by the SAME
// database that stores payments and the admin `receipt_serial_start` setting.
