...
const TEMPLATES: Record<string, Tpl> = {
  lands: {
    ...
    sample: { account_number: "100000000001", dag_no: "123, 124/A, 125-B", land_size: 0.33, owner_type: "owner", field_type: "medium_land", mouza: "Mouza A" },
  ...
  irrigation: {
    ...
    sample: { account_number: "100000000001", dag_no: "123, 124/A", season_year: 2026, season_type: "boro", quantity: 0.33, base_charge: 200, canal_charge: 50, maintenance_charge: 20, other_charge: 0, previous_due_brought: 0, penalty_amount: 0, entry_date: "2026-02-01", note: "" },
