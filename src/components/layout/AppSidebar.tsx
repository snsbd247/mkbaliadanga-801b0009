...
import {
  ...
  ChevronRight, Briefcase, Banknote, BarChart3, Shield, RefreshCw, IdCard, Upload, Package, HelpCircle, History, FolderTree, GitBranch, Activity,
} from "lucide-react";
import {
  ...
  const menu: ParentItem[] = [
    ...
    // ── Irrigation ──
    {
      ...
      children: [
        ...
        { url: "/irrigation/historical-entry", icon: History, label: lang === "bn" ? "পুরাতন রশিদ এন্ট্রি" : "Historical Receipt Entry", permKey: "irrigation" },
    ...
    // ── Reports: Dues / বকেয়া ──
    {
      ...
      children: [
        ...
        { url: "/reports/irrigation-posting-reconciliation", icon: FileBarChart, label: lang === "bn" ? "সেচ পোস্টিং রিকনসিলিয়েশন" : "Irrigation Posting Reconciliation", permKey: "reports" },
