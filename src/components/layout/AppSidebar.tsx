  ...
  const menu: ParentItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { url: "/approvals", icon: ClipboardCheck, label: "Approvals", permKey: "approvals" },
      ],
    },
    {
      key: "accounting", icon: Calculator, label: "Accounting",
      children: [
        { url: "/finance-summary", icon: PieChart, label: "Finance Summary", permKey: "accounting" },
        { url: "/accounts", icon: BookText, label: "Chart of Accounts", permKey: "accounting" },
        { url: "/ledger", icon: Calculator, label: "General Ledger", permKey: "accounting" },
        { url: "/journal-entry", icon: BookKey, label: "Journal Entry", permKey: "accounting" },
        { url: "/financial-reports", icon: TrendingUp, label: "Financial Reports", permKey: "accounting" },
        { url: "/period-close", icon: Lock, label: "Period Close", permKey: "accounting" },
        { url: "/ledger-integrity", icon: ShieldAlert, label: "Ledger Integrity", permKey: "accounting" },
        { url: "/admin/reconciliation", icon: ClipboardCheck, label: "Monthly Reconciliation", permKey: "accounting" },
      ],
    },
    {
