  ...
  const menu: ParentItem[] = [
    ...
    // ── Members & Voters ──
    {
      ...
      children: [
        ...
        { url: "/admin/farmer-merge", icon: Users, label: t("farmerMerge" as any) || "সদস্য একীভূতকরণ", adminOnly: true },
    ...
    // ── Assets / এসেট ──
    {
      ...
      children: [
       ...
       { url: "/assets/maintenance-schedules", icon: Package, label: t("maintenanceSchedules" as any) || "মেরামত সময়সূচি", permKey: "assets" },
       ...
       { url: "/assets/alerts", icon: Package, label: t("assetAlerts" as any) || "এসেট সতর্কতা", permKey: "assets" },
        ...
        { url: "/assets/qr-bulk", icon: Package, label: t("assetBulkOps" as any) || "বাল্ক কার্যক্রম", permKey: "assets" },
        { url: "/assets/depreciation", icon: Package, label: t("assetDepreciation" as any) || "ডিপ্রেসিয়েশন", permKey: "assets" },
    ...
    // ── Reports ──
    {
      ...
      children: [
       ...
       { url: "/reports/receipt-register", icon: FileBarChart, label: t("monthlyReceiptRegister" as any) || "মাসিক রশিদ রেজিস্টার", permKey: "reports" },
       { url: "/reports/officer-summary", icon: FileBarChart, label: t("officerSummary" as any) || "কর্মকর্তা সারসংক্ষেপ", permKey: "reports" },
    ...
    // ── Audit & Monitoring ──
    {
      ...
      children: [
        ...
        { url: "/admin/audit-timeline", icon: ScrollText, label: t("auditTimeline" as any) || "অডিট টাইমলাইন", adminOnly: true },
        { url: "/admin/retry-jobs", icon: RefreshCw, label: t("retryJobs" as any) || "পুনঃচেষ্টা কাজ", adminOnly: true },
        { url: "/admin/duplicate-receipts", icon: ShieldAlert, label: t("duplicateReceiptAudit" as any) || "ডুপ্লিকেট রশিদ", developerOnly: true },
        { url: "/admin/farmer-login-audit", icon: ScrollText, label: t("farmerLoginAudit" as any) || "সদস্য লগইন অডিট", developerOnly: true },
