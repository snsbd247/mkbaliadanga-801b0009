  ...
  useEffect(() => {
    ...
    (async () => {
      const [f, lq] = await Promise.all([
        supabase.from("farmers").select("id,name_en,name_bn,farmer_code,member_no,mobile,village,is_voter,savings_inactive,status").eq("id", form.farmer_id).maybeSingle(),
