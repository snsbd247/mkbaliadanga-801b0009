    ...
    <>
      ...
      <Card className="p-4 mb-4">
        ...
        <div className="flex gap-2 mt-3">
          ...
          <Button size="sm" onClick={exportCombinedPDF} disabled={!farmerId}><FileText className="h-4 w-4 mr-1" />{t("fullStatementPdfLabel" as any) || "Full Statement PDF (Loans + Savings + Irrigation)"}</Button>
        </div>
      </Card>
