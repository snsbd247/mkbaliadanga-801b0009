...
export default function Savings() {
  ...
  async function load() {
    const [f, ts, pr, sp, fsp] = await Promise.all([
      ...
      supabase.from("savings_transactions").select("*, farmers(name_en,farmer_code,member_no,mobile,village)").is("deleted_at" as any, null).order("created_at", { ascending: false }).limit(200),
