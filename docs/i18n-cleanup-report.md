...
Found 417 truly hardcoded Bengali strings (excludes lines that already use lang/tx).
...
src/pages/DataImport.tsx:559: if (!loanId) throw new Error("Installment data missing. Auto-generate or fix the import. / ইন্সটলমেন্ট ডাটা অনুপস্থিত। অটো-জেনারেট অথবা ইমপোর্ট সংশোধন করুন।");
...
src/pages/Loans.tsx:74: `${who} এর Voter / Savings A/C এনাবল নেই — ঋণ এন্ট্রি করা যাবে না।`,
src/pages/Loans.tsx:116: body: `${loan?.farmers?.name_en ?? ""} — ৳${Number(loan?.principal ?? 0).toLocaleString()}`,
