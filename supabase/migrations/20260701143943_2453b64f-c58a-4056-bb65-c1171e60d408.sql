...
ALTER TABLE public.lands ALTER COLUMN land_size TYPE numeric(14,4);
ALTER TABLE public.land_history ALTER COLUMN land_size TYPE numeric(14,4);
...
SELECT l.id,
   ...
   FROM lands l
     ...
     LEFT JOIN mouzas m ON m.id = l.mouza_id
     LEFT JOIN patwaris p ON p.id = l.patwari_id
  WHERE l.deleted_at IS NULL;

GRANT SELECT ON public.lands_with_location TO authenticated;
GRANT ALL ON public.lands_with_location TO service_role;